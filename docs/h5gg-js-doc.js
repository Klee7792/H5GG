...
h5gg.searchGroup('联合值', '默认类型', '搜索下限', '搜索上限', '锚点索引'); //联合搜索, 支持多值多类型搜索
//格式: "100;200;300::9" 表示在9字节内按顺序搜索100、200、300
//多类型: "100;200F64;300::13" 表示100和300是I32, 200是F64
//指定锚点: "@2;100;200;300::9" 表示使用第3个值(索引2)作为锚点
//锚点索引: -1或不指定表示自动选择(推荐)
